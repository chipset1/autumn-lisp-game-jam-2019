...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24151 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24151,ch);
...
if(("\\" === ch__$1)){
var ch_24152__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24152__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24152__$2);
} else {
}
...
var vec__24161 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24161,(0),null);
var start_column = cljs.core.nth.call(null,vec__24161,(1),null);
...
var G__24164 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24164;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__24165 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__24166 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__24166;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__24165;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24167 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24167,(0),null);
var start_column = cljs.core.nth.call(null,vec__24167,(1),null);
...
var vec__24170 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24170,(0),null);
var end_column = cljs.core.nth.call(null,vec__24170,(1),null);
...
var vec__24173 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24173,(0),null);
var start_column = cljs.core.nth.call(null,vec__24173,(1),null);
...
var vec__24176 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24176,(0),null);
var end_column = cljs.core.nth.call(null,vec__24176,(1),null);
...
var vec__24179 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24179,(0),null);
var start_column = cljs.core.nth.call(null,vec__24179,(1),null);
...
var vec__24182 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24182,(0),null);
var end_column = cljs.core.nth.call(null,vec__24182,(1),null);
...
var sb = (function (){var G__24185 = (new goog.string.StringBuffer());
G__24185.append(initch);
...
var G__24187 = (function (){var G__24186 = sb;
G__24186.append(ch);

return G__24186;
})();
var G__24188 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24187;
ch = G__24188;
continue;
}
...
switch (G__24191) {
case "\\":
var G__24195 = (function (){var G__24192 = sb;
G__24192.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24192;
})();
var G__24196 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24195;
ch = G__24196;
continue;
...
break;
default:
var G__24197 = (function (){var G__24193 = sb;
G__24193.append(ch);

return G__24193;
})();
var G__24198 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24197;
ch = G__24198;
continue;
...
var vec__24202 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24202,(0),null);
var column = cljs.core.nth.call(null,vec__24202,(1),null);
...
var vec__24207 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24207,(0),null);
var column = cljs.core.nth.call(null,vec__24207,(1),null);
...
var vec__24212 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__24217 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24217,(0),null);
var start_column = cljs.core.nth.call(null,vec__24217,(1),null);
...
var vec__24220 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24220,(0),null);
var end_column = cljs.core.nth.call(null,vec__24220,(1),null);
...
var G__24223 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24223,true,null,opts,pending_forms);
...
var G__24224 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24224)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24224)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24224)){
...
var _STAR_suppress_read_STAR__orig_val__24225 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24226 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24226;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24225;
}});
...
var G__24227 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24227,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24227,rdr,first_line);
...
var G__24231 = matched;
var G__24232 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24231;
finished = G__24232;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__24233 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24234 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24234;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24233;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__24235 = cljs.tools.reader.arg_env;
var arg_env_temp_val__24236 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__24236;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24237 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24237,"(");
...
var G__24238 = (i + (1));
var G__24239 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__24235;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24240 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24240);
...
var G__24241 = cljs.core.next.call(null,s__$1);
var G__24242 = ret;
s__$1 = G__24241;
r = G__24242;
continue;
...
var G__24244 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24243;
key_vals = G__24244;
continue;
} else {
...
var gensym_env_orig_val__24248 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__24249 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__24249;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__24248;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24250 = token;
var G__24250__$1 = (((G__24250 == null))?null:cljs.core.subs.call(null,G__24250,(1)));
var G__24250__$2 = (((G__24250__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24250__$1));
var G__24250__$3 = (((G__24250__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24250__$2));
var G__24250__$4 = (((G__24250__$3 == null))?null:cljs.core.symbol.call(null,G__24250__$3));
if((G__24250__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24250__$4);
}
})():(function (){var G__24251 = token;
var G__24251__$1 = (((G__24251 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24251));
if((G__24251__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24251__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24262,reader){
...
var eof = cljs.core.get.call(null,map__24263__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24269){
var G__24270 = cljs.core.first.call(null,seq24269);
var seq24269__$1 = cljs.core.next.call(null,seq24269);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24270,seq24269__$1);
});


//# sourceMappingURL=reader.js.map?rel=1592614557191
