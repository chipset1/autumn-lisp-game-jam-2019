...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24026 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24026,ch);
...
if(("\\" === ch__$1)){
var ch_24027__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24027__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24027__$2);
} else {
}

var G__24028 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24028;
continue;
}
}
...
var vec__24036 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24036,(0),null);
var start_column = cljs.core.nth.call(null,vec__24036,(1),null);
...
var G__24039 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24039;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__24040 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__24041 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__24041;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__24040;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24042 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24042,(0),null);
var start_column = cljs.core.nth.call(null,vec__24042,(1),null);
...
var vec__24045 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24045,(0),null);
var end_column = cljs.core.nth.call(null,vec__24045,(1),null);
...
var vec__24048 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24048,(0),null);
var start_column = cljs.core.nth.call(null,vec__24048,(1),null);
...
var vec__24051 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24051,(0),null);
var end_column = cljs.core.nth.call(null,vec__24051,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__24054,(0),null);
var start_column = cljs.core.nth.call(null,vec__24054,(1),null);
...
var vec__24057 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24057,(0),null);
var end_column = cljs.core.nth.call(null,vec__24057,(1),null);
...
var sb = (function (){var G__24060 = (new goog.string.StringBuffer());
G__24060.append(initch);
...
var G__24062 = (function (){var G__24061 = sb;
G__24061.append(ch);
...
switch (G__24066) {
case "\\":
var G__24070 = (function (){var G__24067 = sb;
G__24067.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24067;
})();
var G__24071 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24070;
ch = G__24071;
continue;
...
break;
default:
var G__24072 = (function (){var G__24068 = sb;
G__24068.append(ch);

return G__24068;
})();
var G__24073 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24072;
ch = G__24073;
continue;
...
var vec__24074 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24074,(0),null);
var end_column = cljs.core.nth.call(null,vec__24074,(1),null);
...
var vec__24077 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24077,(0),null);
var column = cljs.core.nth.call(null,vec__24077,(1),null);
...
var vec__24082 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24082,(0),null);
var column = cljs.core.nth.call(null,vec__24082,(1),null);
...
var line = cljs.core.nth.call(null,vec__24087,(0),null);
var column = cljs.core.nth.call(null,vec__24087,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24092 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24092,(0),null);
var start_column = cljs.core.nth.call(null,vec__24092,(1),null);
...
var G__24098 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24098,true,null,opts,pending_forms);
...
var G__24099 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24099)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24099)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24099)){
...
var _STAR_suppress_read_STAR__orig_val__24100 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24101 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24101;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24100;
}});
...
var G__24102 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24102,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24102,rdr,first_line);
...
var G__24106 = matched;
var G__24107 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24106;
finished = G__24107;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__24108 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24109 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24109;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24108;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__24110 = cljs.tools.reader.arg_env;
var arg_env_temp_val__24111 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__24111;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24112 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24112,"(");
...
var G__24113 = (i + (1));
var G__24114 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__24110;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24115 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24115);
...
var G__24116 = cljs.core.next.call(null,s__$1);
var G__24117 = ret;
s__$1 = G__24116;
r = G__24117;
continue;
...
var G__24118 = cljs.core.next.call(null,s);
var G__24119 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24118;
key_vals = G__24119;
continue;
} else {
...
var gensym_env_orig_val__24123 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__24124 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__24124;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__24123;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24125 = token;
var G__24125__$1 = (((G__24125 == null))?null:cljs.core.subs.call(null,G__24125,(1)));
var G__24125__$2 = (((G__24125__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24125__$1));
var G__24125__$3 = (((G__24125__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24125__$2));
var G__24125__$4 = (((G__24125__$3 == null))?null:cljs.core.symbol.call(null,G__24125__$3));
if((G__24125__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24125__$4);
}
})():(function (){var G__24126 = token;
var G__24126__$1 = (((G__24126 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24126));
if((G__24126__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24126__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24137,reader){
...
var opts = map__24138__$1;
var eof = cljs.core.get.call(null,map__24138__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___24146 = arguments.length;
var i__4731__auto___24147 = (0);
while(true){
if((i__4731__auto___24147 < len__4730__auto___24146)){
args__4736__auto__.push((arguments[i__4731__auto___24147]));

var G__24148 = (i__4731__auto___24147 + (1));
i__4731__auto___24147 = G__24148;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24144){
...
//# sourceMappingURL=reader.js.map?rel=1570822062335
