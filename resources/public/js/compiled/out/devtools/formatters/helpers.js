...
var G__22007 = devtools.prefs.pref.call(null,v);
v = G__22007;
continue;
} else {
return v;
...
}catch (e22010){var _e__20990__auto__ = e22010;
return false;
}})();
...
}catch (e22014){var _e__20990__auto__ = e22014;
return false;
}})();
...
}catch (e22016){var _e__20990__auto__ = e22016;
return false;
}}
}
});
...
var vec__22018 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__22018,(0),null);
var name = cljs.core.nth.call(null,vec__22018,(1),null);
...
return cljs.core.some.call(null,(function (p1__22021_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__22021_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1592614551514
