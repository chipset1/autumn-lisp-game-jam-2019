...
}catch (e24411){var _e = e24411;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___24414 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___24414)){
var seen_errors_24415 = temp__5718__auto___24414;
if(cljs.core.truth_(seen_errors_24415.has(self))){
} else {
seen_errors_24415.add(self);

var temp__5720__auto___24416 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___24416)){
var sense_24417 = temp__5720__auto___24416;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_24417)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1570822062977
