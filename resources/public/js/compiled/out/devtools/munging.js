...
var o21902 = temp__5718__auto__;
var temp__5718__auto____$1 = (o21902["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o21903 = temp__5718__auto____$1;
return (o21903["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20983__auto__ = f;
return (o__20983__auto__["toString"]).call(o__20983__auto__);
} else {
return "";
}
}catch (e21904){var _ = e21904;
return "";
}});
...
try{var o__20983__auto___21906 = t;
(o__20983__auto___21906["cljs$lang$ctorPrWriter"]).call(o__20983__auto___21906,t,writer);
}catch (e21905){var __21907 = e21905;
}
...
var char_code = (function (){var o__20983__auto__ = (new String(char$));
return (o__20983__auto__["charCodeAt"]).call(o__20983__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20983__auto__ = String;
return (o__20983__auto__["fromCharCode"]).call(o__20983__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21908 = num_code;
switch (G__21908) {
case (1):
return (185);
...
var o__20983__auto__ = String;
return (o__20983__auto__["fromCharCode"]).call(o__20983__auto__,superscript_code);
});
/**
...
}catch (e21910){var _e__20990__auto__ = e21910;
return false;
}})())){
...
var vec__21911 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21911,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o21914 = temp__5718__auto__;
var temp__5718__auto____$1 = (o21914["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o21915 = temp__5718__auto____$1;
return (o21915["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21918){
var vec__21919 = p__21918;
var ns_detector = cljs.core.nth.call(null,vec__21919,(0),null);
...
var G__21925 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21926 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21925;
remaining_tokens = G__21926;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21916){
var G__21917 = cljs.core.first.call(null,seq21916);
var seq21916__$1 = cljs.core.next.call(null,seq21916);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21917,seq21916__$1);
});
...
var vec__21930 = cljs.core.split_with.call(null,(function (p1__21929_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21929_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21930,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21930,(1),null);
...
var vec__21936 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21936,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21936,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21939 = cljs.core.rest.call(null,remaining_tokens);
var G__21940 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21939;
name_tokens = G__21940;
continue;
} else {
...
var vec__21943 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21943,(0),null);
var arity = cljs.core.nth.call(null,vec__21943,(1),null);
var vec__21946 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21946,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21946,(1),null);
var vec__21949 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21949,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21949,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21949,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21949,(3),null);
...
var vec__21955 = result;
var munged_ns = cljs.core.nth.call(null,vec__21955,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21955,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21955,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21955,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21955,(4),null);
var arity = cljs.core.nth.call(null,vec__21955,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__21959 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__21959,(0),null);
var args = cljs.core.nth.call(null,vec__21959,(1),null);
var vec__21962 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21962,(0),null);
var name = cljs.core.nth.call(null,vec__21962,(1),null);
...
var G__21965 = (arity + (1));
var G__21966 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21967){
var vec__21968 = p__21967;
var arity = cljs.core.nth.call(null,vec__21968,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21968,(1),null);
...
return cljs.core.get.call(null,arities,p1__21971_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21972_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21975){
var vec__21976 = p__21975;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21976,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21973){
var G__21974 = cljs.core.first.call(null,seq21973);
var seq21973__$1 = cljs.core.next.call(null,seq21973);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21974,seq21973__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__21984__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21984__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21984__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21984__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21985 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21985,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21985,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21985,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21985,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21985,(4),null);
var arity = cljs.core.nth.call(null,vec__21985,(5),null);
...
var o__20983__auto__ = f;
return (o__20983__auto__["getBasis"]).call(o__20983__auto__);
});
/**
...
}catch (e21989){var _e__20990__auto__ = e21989;
...
var G__21990 = (obj[cljs.core.first.call(null,path)]);
var G__21991 = cljs.core.rest.call(null,path);
obj = G__21990;
path = G__21991;
continue;
} else {
...
return (function (accum,p__21992){
var vec__21993 = p__21992;
var bit = cljs.core.nth.call(null,vec__21993,(0),null);
var protocol = cljs.core.nth.call(null,vec__21993,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21996){
var vec__21997 = p__21996;
var ns = cljs.core.nth.call(null,vec__21997,(0),null);
var name = cljs.core.nth.call(null,vec__21997,(1),null);
var selector = cljs.core.nth.call(null,vec__21997,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__22002,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22002,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22002,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22000_SHARP_){
return (obj[cljs.core.first.call(null,p1__22000_SHARP_)]);
});})(name,sorted_matches,vec__22002,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1592614551314
