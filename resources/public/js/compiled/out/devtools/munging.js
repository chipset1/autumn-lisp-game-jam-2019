...
var o21777 = temp__5718__auto__;
var temp__5718__auto____$1 = (o21777["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o21778 = temp__5718__auto____$1;
return (o21778["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__20858__auto___21781 = t;
(o__20858__auto___21781["cljs$lang$ctorPrWriter"]).call(o__20858__auto___21781,t,writer);
}catch (e21780){var __21782 = e21780;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21783 = num_code;
switch (G__21783) {
case (1):
return (185);
...
}catch (e21785){var _e__20865__auto__ = e21785;
return false;
}})())){
...
var vec__21786 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21786,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o21789 = temp__5718__auto__;
var temp__5718__auto____$1 = (o21789["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o21790 = temp__5718__auto____$1;
return (o21790["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21793){
var vec__21794 = p__21793;
var ns_detector = cljs.core.nth.call(null,vec__21794,(0),null);
...
var G__21800 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21801 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21800;
remaining_tokens = G__21801;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21791){
...
var vec__21805 = cljs.core.split_with.call(null,(function (p1__21804_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21804_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21805,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21805,(1),null);
...
var vec__21811 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21811,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21811,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21814 = cljs.core.rest.call(null,remaining_tokens);
var G__21815 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21814;
name_tokens = G__21815;
continue;
} else {
...
var vec__21818 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21818,(0),null);
var arity = cljs.core.nth.call(null,vec__21818,(1),null);
var vec__21821 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21821,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21821,(1),null);
var vec__21824 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21824,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21824,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21824,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21824,(3),null);
...
var vec__21830 = result;
var munged_ns = cljs.core.nth.call(null,vec__21830,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21830,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21830,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21830,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21830,(4),null);
var arity = cljs.core.nth.call(null,vec__21830,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__21834 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__21834,(0),null);
var args = cljs.core.nth.call(null,vec__21834,(1),null);
var vec__21837 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21837,(0),null);
var name = cljs.core.nth.call(null,vec__21837,(1),null);
...
var G__21840 = (arity + (1));
var G__21841 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21842){
var vec__21843 = p__21842;
var arity = cljs.core.nth.call(null,vec__21843,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21843,(1),null);
...
return cljs.core.get.call(null,arities,p1__21846_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21847_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21850){
var vec__21851 = p__21850;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21851,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21848){
var G__21849 = cljs.core.first.call(null,seq21848);
var seq21848__$1 = cljs.core.next.call(null,seq21848);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21849,seq21848__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__21859__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21859__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21859__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21859__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21860 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21860,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21860,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21860,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21860,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21860,(4),null);
var arity = cljs.core.nth.call(null,vec__21860,(5),null);
...
}catch (e21864){var _e__20865__auto__ = e21864;
...
var G__21865 = (obj[cljs.core.first.call(null,path)]);
var G__21866 = cljs.core.rest.call(null,path);
obj = G__21865;
path = G__21866;
continue;
} else {
...
return (function (accum,p__21867){
var vec__21868 = p__21867;
var bit = cljs.core.nth.call(null,vec__21868,(0),null);
var protocol = cljs.core.nth.call(null,vec__21868,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21871){
var vec__21872 = p__21871;
var ns = cljs.core.nth.call(null,vec__21872,(0),null);
var name = cljs.core.nth.call(null,vec__21872,(1),null);
var selector = cljs.core.nth.call(null,vec__21872,(2),null);
...
return (function (p__21876){
var vec__21877 = p__21876;
var munged_name = cljs.core.nth.call(null,vec__21877,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21877,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21877,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21875_SHARP_){
return (obj[cljs.core.first.call(null,p1__21875_SHARP_)]);
});})(name,sorted_matches,vec__21877,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1570822057836
