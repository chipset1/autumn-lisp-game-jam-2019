...
return (new CustomEvent(event_name,(function (){var obj27977 = ({"detail":data});
return obj27977;
})()));
} else {
...
var f = (function (){var pred__27984 = cljs.core._EQ_;
var expr__27985 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27984.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27985))){
return ((function (pred__27984,expr__27985){
return (function (p1__27978_SHARP_){
return console.warn(p1__27978_SHARP_);
});
;})(pred__27984,expr__27985))
} else {
if(cljs.core.truth_(pred__27984.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27985))){
return ((function (pred__27984,expr__27985){
return (function (p1__27979_SHARP_){
return console.debug(p1__27979_SHARP_);
});
;})(pred__27984,expr__27985))
} else {
if(cljs.core.truth_(pred__27984.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27985))){
return ((function (pred__27984,expr__27985){
return (function (p1__27980_SHARP_){
return console.error(p1__27980_SHARP_);
});
;})(pred__27984,expr__27985))
} else {
return ((function (pred__27984,expr__27985){
return (function (p1__27981_SHARP_){
return console.log(p1__27981_SHARP_);
});
;})(pred__27984,expr__27985))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27988){
...
var eval_fn = cljs.core.get.call(null,map__27989__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27991_SHARP_);
});})(new_def))
);
...
return (function (p__27992){
var vec__27993 = p__27992;
var ky = cljs.core.nth.call(null,vec__27993,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1592614560556
