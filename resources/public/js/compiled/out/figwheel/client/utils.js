...
return (new CustomEvent(event_name,(function (){var obj27852 = ({"detail":data});
return obj27852;
})()));
} else {
...
var f = (function (){var pred__27859 = cljs.core._EQ_;
var expr__27860 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27859.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27860))){
return ((function (pred__27859,expr__27860){
return (function (p1__27853_SHARP_){
return console.warn(p1__27853_SHARP_);
});
;})(pred__27859,expr__27860))
} else {
if(cljs.core.truth_(pred__27859.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27860))){
return ((function (pred__27859,expr__27860){
return (function (p1__27854_SHARP_){
return console.debug(p1__27854_SHARP_);
});
;})(pred__27859,expr__27860))
} else {
if(cljs.core.truth_(pred__27859.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27860))){
return ((function (pred__27859,expr__27860){
return (function (p1__27855_SHARP_){
return console.error(p1__27855_SHARP_);
});
;})(pred__27859,expr__27860))
} else {
return ((function (pred__27859,expr__27860){
return (function (p1__27856_SHARP_){
return console.log(p1__27856_SHARP_);
});
;})(pred__27859,expr__27860))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27863){
...
var eval_fn = cljs.core.get.call(null,map__27864__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27866_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27868,(0),null);
...
}catch (e27873){if((e27873 instanceof Error)){
var e = e27873;
return not_found;
} else {
throw e27873;
...
//# sourceMappingURL=utils.js.map?rel=1570822064531
